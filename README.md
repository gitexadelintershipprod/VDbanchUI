...
> 2. It creates `C:\install\ssh\id_rsa`, `id_rsa.pub`, and **`C:\install\master_id_ed25519.pub`**.  
> 3. **Copy `master_id_ed25519.pub` (and the rest of each slave’s kit) onto every slave** into `C:\install` or `/root/install`.  
